            ...
            >
              <FormControlLabel
                ...
                sx={{
                  ...
                  border: "1px solid",
                  borderColor:paymentSelect == 1 ? "#BA183C" : "#CEDCF6",
                  borderRadius: "8px",
                  ml: 0,
                  width: {
                    xs: "100%",
                  ...
                  backgroundColor: paymentSelect == 1 ? "#FFEEF2" : "",
                  mt: 1,
                }}
              />
              <FormControlLabel
                ...
                sx={{
                  padding: "5px 16px 5px 18px",
                  border: "1px solid",
                  borderColor:paymentSelect == 2 ? "#BA183C" : "#CEDCF6",
                  borderRadius: "8px",
                  backgroundColor: paymentSelect == 2 ? "#FFEEF2" : "",
                  ml: 0,
                  width: {
                    xs: "100%",
                    sm: "50%",
